...
┌─────────────────────────────────────────────────────┐
│  ブラウザ                                           │
│  React 19 SPA（Vite 8 / TypeScript 5.9）           │
...
- **リアルタイム機能**（新着ツイート通知・いいね数の即時反映）は GraphQL Subscription + SSE で実現しています。
...
| 技術               | バージョン        | 用途                                            |
| ------------------ | ----------------- | ----------------------------------------------- |
| Ruby on Rails      | 8.0（API モード） | API サーバー                                    |
...
| HeroUI                | v2         | UI コンポーネントライブラリ（75+ コンポーネント）                   |
