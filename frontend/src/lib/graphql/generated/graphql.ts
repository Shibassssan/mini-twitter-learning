...
export type Subscription = {
  ...
  tweetLikeUpdated: Tweet;
};


export type SubscriptionTweetLikeUpdatedArgs = {
...
export type TweetAddedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type TweetAddedSubscription = { __typename?: 'Subscription', tweetAdded: { __typename?: 'Tweet', id: string, content: string, createdAt: any, likesCount: number, isLikedByMe: boolean, author: { __typename?: 'User', id: string, username: string, displayName: string, isFollowedByMe: boolean } } };

export type TweetLikeUpdatedSubscriptionVariables = Exact<{
  tweetId: Scalars['ID']['input'];
}>;


export type TweetLikeUpdatedSubscription = { __typename?: 'Subscription', tweetLikeUpdated: { __typename?: 'Tweet', id: string, likesCount: number, isLikedByMe: boolean } };
...
export const TweetAddedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"TweetAdded"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tweetAdded"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"likesCount"}},{"kind":"Field","name":{"kind":"Name","value":"isLikedByMe"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"isFollowedByMe"}}]}}]}}]}}]} as unknown as DocumentNode<TweetAddedSubscription, TweetAddedSubscriptionVariables>;
export const TweetLikeUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"TweetLikeUpdated"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tweetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tweetLikeUpdated"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tweetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tweetId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"likesCount"}},{"kind":"Field","name":{"kind":"Name","value":"isLikedByMe"}}]}}]}}]} as unknown as DocumentNode<TweetLikeUpdatedSubscription, TweetLikeUpdatedSubscriptionVariables>;
